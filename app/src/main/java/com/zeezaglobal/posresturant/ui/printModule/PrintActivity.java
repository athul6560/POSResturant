...
public class PrintActivity extends AppCompatActivity {
    ...
    private void addToSales(Long BillNumber, int TockenNumber, Double TotalAmount, String DateTime, String paymentMethod) {
        Sale sale = new Sale(
    ...
    public AsyncEscPosPrinter getAsyncEscPosPrinter(DeviceConnection printerConnection) {
        ...
        double subtotal = cartItemList.stream()
                ...
                .sum();
        addToSales(billNumber, tokenNumber, subtotal, format.format(new Date()),CartItemStore.INSTANCE.getPaymentMethod());
