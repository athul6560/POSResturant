...
class POSApp : Application() {
    ...
    private suspend fun populateDatabase(database: POSDatabase) {
        ...
        val items = listOf(
            ...
            Item(groupId = 1, itemName = "Lemon Tea", itemDescription = "7OZ", itemPrice = 40.0),
            Item(groupId = 1, itemName = "Green Tea with Honey", itemDescription = "7OZ", itemPrice = 40.0),
            Item(groupId = 1, itemName = "Black Tea with Ginger", itemDescription = "7OZ", itemPrice = 40.0),
            ...
            Item(groupId = 4, itemName = "Cranberry Coffee", itemDescription = "8OZ", itemPrice = 120.0),
            ...
            Item(groupId = 9, itemName = "Popsicle Jamun", itemDescription = "8OZ", itemPrice = 150.0),
            Item(groupId = 9, itemName = "Popsicle Guvava", itemDescription = "8OZ", itemPrice = 150.0),
            Item(groupId = 9, itemName = "Popsicle Grape", itemDescription = "8OZ", itemPrice = 150.0),
            ...
            Item(groupId = 10, itemName = "mango kesar  shake", itemDescription = "8OZ", itemPrice = 195.0),
            Item(groupId = 10, itemName = "butterscoch frappe", itemDescription = "8OZ", itemPrice = 195.0),
            Item(groupId = 10, itemName = "crunchy biscoff shake", itemDescription = "8OZ", itemPrice = 195.0),
